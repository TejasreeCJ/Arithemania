        ...
        <div className="main-visualization">
          ...
          <div className="visualization-content">
            ...
            <div className="bg-white rounded-lg shadow-md p-4 mb-6">
              ...
              <button className="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600" onClick={() => window.open('https://arithmania.vercel.app')}>View Simulation</button>
            </div>
          </div>
              ...
              <div className="insight-card">
                ...
                <ul className="insight-list">
                  {generateConservationRecommendations(activeReserveInfo, spatialData).map((rec, index) => (
                    <li key={index} className="insight-item">
                      <span className={`mr-2 ${
                        rec.priority === 'high' ? 'text-red' :
                        rec.priority === 'medium' ? 'text-amber' :
                        'text-green'
                      }`}>•</span>
                      <span>{rec.text}</span>
                    </li>
